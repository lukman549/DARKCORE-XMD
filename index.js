const {
  ...
  const ownerNumber = ['256758715404']
...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    ...
    const sessdata = config.SESSION_ID.replace("DARKCORE-XMD~", '');
    try {
...
const port = process.env.PORT || 9090;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('256758715404', '256708360344', '256708360344');
...
if (senderNumber.includes("256758715404") && !isReact) {
